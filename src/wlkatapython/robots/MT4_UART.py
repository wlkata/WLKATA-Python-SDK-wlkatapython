...
class MT4_UART(WLKATA_UART):
    """Control class for the WLKATA MT4 4-axis robotic arm.

    Inherits from WLKATA_UART and overrides config for the MT4's
    ...
    def writeCoordinate(self, motion, position, x=None, y=None, z=None, a=None):
        """Move the MT4 to specified Cartesian coordinates.
    ...
    def writeAngle(self, position, x=None, y=None, z=None, a=None):
        """Move the MT4 to specified joint angles.
    ...
    def getAngle(self, num):
        """Get the angle of a specific MT4 axis.
    ...
    def getCoordinate(self, num):
        """Get a Cartesian coordinate of the MT4 end effector.
